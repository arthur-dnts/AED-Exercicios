...
## Classificação de Variáveis e Distribuição de frequência de Dados Categóricos
...
### [AED_Análise_Gráfica.ipynb](https://github.com/arthur-dnts/AED-Exercicios/blob/main/anotacoes/AED_An%C3%A1lise_Gr%C3%A1fica.ipynb)
Arquivo com anotações pessoais do capítulo 1 do curso [Introduction to Exploratory Data Analysis](https://app.datacamp.com/learn/courses/statistical-thinking-in-python-part-1) do DataCamp
